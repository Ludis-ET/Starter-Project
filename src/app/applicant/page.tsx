      ...
      <main className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 text-lg">
            Your journey to join A2SV continues here. Track your progress and
            next steps.
          </p>
        </div>
              ...
              <Card className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white">
                <CardHeader>
                  ...
                  <CardDescription className="text-indigo-100">
                    Join Africa's most exclusive tech program and fast-track
                    your career.
                  </CardDescription>
                </CardHeader>
                <CardContent>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Complete and submit your A2SV application
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600">
                          Practice coding problems and review algorithms
                        </p>
                      </div>
                    </div>
                  </div>
